  ...
  <div v-else id="pp-home" class="pp-wrap">
    ...
    <div class="pp-card pp-m-t-5">
      ...
      <div class="pp-card-body">
        <p><?php echo sprintf(
              esc_html__('Your branded tracking page is ready, the URL is %1$s, add it to your store menus so your customers can track orders there.', 'parcelpanel'),
              '<a :href="pageParam.track_page_link" target="_blank">{{pageParam.track_page_link}}</a>'
            )
            ?></p>
        <p class="pp-m-t-2"><?php echo sprintf(
                              esc_html__('Don’t know how to do this? Please follow %1$sthis instruction%2$s.', 'parcelpanel'),
                              '<a href="https://docs.parcelpanel.com/woocommerce/article/56" target="_blank">',
                              '</a>'
                            )
                            ?></p>
    ...
    <div class="pp-card">
      ...
      <div class="pp-card-body">
        <p>
          <?php echo sprintf(
            esc_html__('Use mapping feature to bulk import tracking number with a CSV file, or manually add one by one in the Edit order page. %1$sLearn more%2$s.', 'parcelpanel'),
            '<a href="https://docs.parcelpanel.com/woocommerce/article/how-does-parcelpanel-work-in-woocommerce/" target="_blank">',
            '</a>'
          )
          ?>
        </p>
