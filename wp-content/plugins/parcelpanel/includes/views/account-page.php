        ...
        <template v-else-if="statusRequest.FINISHED === reqStatus">
          ...
          <div class="pp-card" v-if="isUnlimitedPlan">
            ...
            <div class="pp-card-body">
              ...
              <p style="color: #50575E;"><?php echo sprintf(
                                            esc_html__('Note: Remaining means you have %1$s available quota.', 'parcelpanel'),
                                            'unlimited'
                                          ) ?></p>
            </div>
          </div>
