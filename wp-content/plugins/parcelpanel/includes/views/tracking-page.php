        ...
        <div class="pp-taggle">
          <div class="pp-row" type="flex">
            <div class="pp-col-xs-12 pp-col-md-4 pp-p-r-5 pp-taggle-body-min-wdith">
              ...
              <p><?php
                  echo sprintf(
                    esc_html__('View the CSS codes here you used to do the custom change of your tracking page, if you would like to change codes, please %1$scontact us%2$s or follow %3$sthis instruction%4$s.', 'parcelpanel'),
                    '<a @click="onContactUs" href="javascript:">',
                    '</a>',
                    '<a href="https://docs.parcelpanel.com/woocommerce/article/customize-your-tracking-page-via-css-codes/" target="_blank">',
                    '</a>'
                  )
                  ?></p>
            </div>
