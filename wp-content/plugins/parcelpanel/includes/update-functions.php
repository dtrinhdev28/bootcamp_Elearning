...
function parcelpanel_update_290_add_tracking()
{
    ...
    $result = $wpdb->query("ALTER TABLE {$TABLE_TRACKING} ADD last_event_at int(10) unsigned NOT NULL DEFAULT 0 AFTER last_event");

    (new ParcelPanelFunction)->parcelpanel_log('parcelpanel_update_290_add_tracking: ' . json_encode([
